...
author: mark
excerpt: |
  I've been looking for a while for a machine that can run a RAID array, giving me somewhere to put my media and backups that wont lose everything if a hard disk dies.  My real problem when looking for something that fits my needs is price. There's plenty of capable devices out there, but they tend to get expensive quickly - a <a href="http://www.drobo.com/">Drobo</a> or multi-disk NAS box can set you back £300 before you've bought any disks.
