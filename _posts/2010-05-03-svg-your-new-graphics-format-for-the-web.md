...
excerpt: |
  ...
  SVG is also an XML format, so is pretty easy to learn for anyone used to XHTML or other XML formats. <a href="http://barrenfrozenwasteland.com/dev8d/">It even supports CSS styling</a>, including pseudo-classes like :hover!
...
SVG is also an XML format, so is pretty easy to learn for anyone used to XHTML or other XML formats. [It even supports CSS styling](http://barrenfrozenwasteland.com/dev8d/), including pseudo-classes like :hover!
